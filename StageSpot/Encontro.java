...
public class Encontro extends Evento {
    ...
    public static void cadastrarEvento(Scanner scanner) {
        ...
        while (continuar) {
            ...
            if (tipoEncontro == 1) {
                ...
                ingresso = new Ingresso(tipoIngresso, setor, preco, siteCompra, cupomDesconto);
            } else if (tipoEncontro == 2) {
                ingresso = new Ingresso("Gratuito", "Gratuito", 0, "Gratuito", "Gratuito");
            } else {
                System.out.println("Opção inválida. Tentando novamente.");
                continue;
            }
            ...
            System.out.println("1 - Cadastrar um novo encontro de fãs");
            ...
            if (opcao == 0) {
                ...
                Encontro.cadastrarEvento(scanner); //chamada polimorfica de si mesmo
            } else if (opcao == 2) {
                continuar = false;
            } else {
    ...
    public static void listarEncontros() {
        if (listaEncontros.isEmpty()) {
            ...
            for (Encontro encontro : listaEncontros) {
                String preco = encontro.getIngresso().isGratuito() ? "Gratuito" : String.valueOf(encontro.getIngresso().getPreco());
                System.out.println("Nome: " + encontro.getNome() + ", Data: " + encontro.getData() + ", Hora de Início: " + encontro.getHoraInicio() + ", Hora de Término: " + encontro.getHoraFim()
                        + ", Artista: " + encontro.getArtista().getNome() + ", Preço do Ingresso a partir de: " + preco
    ...
    protected void exibirDetalhes() {
        ...
        if (getIngresso().isGratuito()) {
            System.out.println("Preço do ingresso a partir de: Gratuito");
            System.out.println("Site de Compra: Gratuito");
        } else {
            System.out.println("Preço do ingresso a partir de: " + getIngresso().getPreco());
            System.out.println("Site de Compra: " + getIngresso().getSiteCompra());
        }
    }
